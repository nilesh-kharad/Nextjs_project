...
const otherInstitutesTable = () => {
    const [rows, setRows] = React.useState([{}]);
    const columnsArray = ["Name of Institution(s)", "Year of Establishment", "Programs of study", "Location"]; // pass columns here dynamically
    ...
    return (
        <>
            <Box sx={{ mt: 3 }}>
                <InputLabel id="demo-controlled-open-select-label">Other Academic Institutions of the Trust/Society/Company etc. if any. (Add rows as needed)</InputLabel>
...
export default otherInstitutesTable